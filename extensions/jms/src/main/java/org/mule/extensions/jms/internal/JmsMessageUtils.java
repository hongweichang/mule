...
public class JmsMessageUtils {
  ...
  public static Object toObject(Message source, JmsSpecification jmsSpec, String encoding) throws JMSException, IOException {
   ...
   */
  public static byte[] toByteArray(Message message, JmsSpecification jmsSpec, String encoding) throws JMSException, IOException {
