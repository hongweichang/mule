...
//TODO CachingConnectionFactory only supports JMS 1.1 connection factories currently. - Review default cache with 1.0.2b
public class Jms102bSupport extends Jms11Support {
  ...
  public Jms102bSupport(LookupJndiDestination lookupJndiDestination, Function<String, Destination> jndiObjectSupplier) {
  ...
  public Session createSession(Connection connection, boolean topic, boolean transacted,
    ...
    if (topic && connection instanceof TopicConnection) {
      ...
      return ((QueueConnection) connection).createQueueSession(
                                                               transacted, (transacted ? SESSION_TRANSACTED : ackMode));
    } else {
